---
title: "Everything You Need to Know About Adversarial Training in NLP"
date: "2021-01-04"
excerpt: "Adversarial examples expose fundamental limitations of deep neural networks. This post covers what they are, how adversarial training works, and why the robustness-generalisation trade-off is harder to solve than it looks."
heroImage: "/images/blog/adv-training/hero-image.jpg"
tags: ["NLP", "Adversarial Training", "Deep Learning", "Machine Learning", "AI Safety"]
published: true
---
...
<img
  src="/images/blog/adv-training/adv-example-eq.jpg"
  alt="Adversarial example formulation: x' = x + η, f(x) = y, x ∈ X; f(x') ≠ y (untargeted) or f(x') = y', y' ≠ y (targeted)"
...
<img
  src="/images/blog/adv-training/adv-example-image.jpg"
  alt="Szegedy adversarial examples: input images, small perturbations added, and perturbed outputs all misclassified as ostrich"
  className="my-6 mx-auto rounded-lg"
/>
...
2. The second and more effective way is to incorporate input perturbations as part of the model training process.
...
<img
  src="/images/blog/adv-training/reguliser.jpg"
  alt="Goodfellow's adversarial regulariser: modified ERM loss function with adversarial perturbation term weighted by α"
  className="my-6 mx-auto rounded-lg"
/>
...
<img
  src="/images/blog/adv-training/min-max.jpg"
  alt="Min-max adversarial training objective: min over θ of E[(Z,y)~D of max over ||δ||≤ε of L(f_θ(X+δ), y)]"
  className="my-6 mx-auto rounded-lg"
/>
...
<img
  src="/images/blog/adv-training/pseudocode.jpg"
  alt="K-PGD adversarial training algorithm pseudocode"
  className="my-6 mx-auto rounded-lg"
/>
...
<img
  src="/images/blog/adv-training/adversary.jpg"
  alt="Three plots showing test loss vs training data size for weak, medium, and strong adversaries"
  className="my-6 mx-auto rounded-lg"
/>
...
<img
  src="/images/blog/adv-training/results.jpg"
  alt="Table showing standard vs adversarial training on CIFAR-10 accuracies"
  className="my-6 mx-auto rounded-lg"
/>
...
1. Szegedy, Christian, et al. 'Intriguing Properties of Neural Networks'. ArXiv:1312.6199 [Cs], Feb. 2014. arXiv.org, [http://arxiv.org/abs/1312.6199](http://arxiv.org/abs/1312.6199).
2. Jia, Robin, and Percy Liang. 'Adversarial Examples for Evaluating Reading Comprehension Systems'. ArXiv:1707.07328 [Cs], July 2017. arXiv.org, [http://arxiv.org/abs/1707.07328](http://arxiv.org/abs/1707.07328).
3. Liang, Bin, et al. 'Deep Text Classification Can Be Fooled'. Proceedings of the Twenty-Seventh International Joint Conference on Artificial Intelligence, 2018, pp. 4208–15. doi:10.24963/ijcai.2018/585.
4. Samanta, Suranjana, and Sameep Mehta. 'Towards Crafting Text Adversarial Samples'. ArXiv:1707.02812 [Cs], July 2017. arXiv.org, [http://arxiv.org/abs/1707.02812](http://arxiv.org/abs/1707.02812).
5. Jin, Di, et al. 'Is BERT Really Robust? A Strong Baseline for Natural Language Attack on Text Classification and Entailment'. ArXiv:1907.11932 [Cs], Apr. 2020. arXiv.org, [http://arxiv.org/abs/1907.11932](http://arxiv.org/abs/1907.11932).
6. Goodfellow, Ian J., et al. 'Explaining and Harnessing Adversarial Examples'. ArXiv:1412.6572 [Cs, Stat], Mar. 2015. arXiv.org, [http://arxiv.org/abs/1412.6572](http://arxiv.org/abs/1412.6572).
7. Madry, Aleksander, et al. 'Towards Deep Learning Models Resistant to Adversarial Attacks'. ArXiv:1706.06083 [Cs, Stat], Sept. 2019. arXiv.org, [http://arxiv.org/abs/1706.06083](http://arxiv.org/abs/1706.06083).
8. Shafahi, Ali, et al. 'Adversarial Training for Free!' ArXiv:1904.12843 [Cs, Stat], Nov. 2019. arXiv.org, [http://arxiv.org/abs/1904.12843](http://arxiv.org/abs/1904.12843).
9. Zhang, Dinghuai, et al. 'You Only Propagate Once: Accelerating Adversarial Training via Maximal Principle'. ArXiv:1905.00877 [Cs, Math, Stat], Nov. 2019. arXiv.org, [http://arxiv.org/abs/1905.00877](http://arxiv.org/abs/1905.00877).
10. Zhu, Chen, et al. 'FreeLB: Enhanced Adversarial Training for Natural Language Understanding'. ArXiv:1909.11764 [Cs], Apr. 2020. arXiv.org, [http://arxiv.org/abs/1909.11764](http://arxiv.org/abs/1909.11764).
11. Tsipras, Dimitris, et al. 'Robustness May Be at Odds with Accuracy'. ArXiv:1805.12152 [Cs, Stat], Sept. 2019. arXiv.org, [http://arxiv.org/abs/1805.12152](http://arxiv.org/abs/1805.12152).
12. Raghunathan, Aditi, et al. 'Adversarial Training Can Hurt Generalization'. ArXiv:1906.06032 [Cs, Stat], Aug. 2019. arXiv.org, [http://arxiv.org/abs/1906.06032](http://arxiv.org/abs/1906.06032).
13. Min, Yifei, et al. 'The Curious Case of Adversarially Robust Models: More Data Can Help, Double Descend, or Hurt Generalization'. ArXiv:2002.11080 [Cs, Stat], June 2020. arXiv.org, [http://arxiv.org/abs/2002.11080](http://arxiv.org/abs/2002.11080).
