...
export const PROJECTS: Project[] = [
  // ── Research ──────────────────────────────────────────────────────────────
  {
    name: 'Climate Policy Equity Framework',
    description:
    ...
    tags: ['Climate Policy', 'Multi-Agent RL', 'AI for Social Impact'],
    links: [
      { label: 'Paper', url: 'https://www.ijcai.org/proceedings/2025/1064.pdf' },
      { label: 'Code', url: 'https://github.com/pollockDeVis/JUSTICE' },
    ],
    featured: true,
    category: 'research',
  ...
  {
    name: 'Spatio-Temporal Simplicial Complexes for Multivariate Time Series',
    description:
    ...
    tags: ['Spatio-Temporal Forecasting', 'Graph ML'],
    links: [
      { label: 'Thesis', url: 'https://repository.tudelft.nl/record/uuid:ff18b94d-d547-4df2-91b0-b8174aee7781' },
      { label: 'Code', url: 'https://github.com/aditwhorra42/product-complex' },
    ],
    featured: true,
    category: 'research',
    image: '/images/projects/simplicial.png',
  },
  {
    name: 'GraphCast Lite: Scalable GNNs for Weather Forecasting',
    description:
    ...
    tags: ['Weather Forecasting', 'Graph ML'],
    links: [
      { label: 'Code', url: 'https://github.com/aditwhorra42/graphcast-lite' },
    ],
    featured: true,
    category: 'research',
    image: '/images/projects/graph_cast.jpg',
  },
  {
    name: 'Formally Verifying Decomposed Reinforcement Learning',
    description:
    ...
    tags: ['Formal Verification', 'Reinforcement Learning', 'AI Safety'],
    links: [
      { label: 'Code', url: 'https://github.com/aidm-group-4/vdrl' },
    ],
    featured: true,
    category: 'research',
    image: '/images/projects/vdrl.png',
  },
  {
    name: 'Reproducing Prototypical Networks for Few-Shot Learning',
    description:
    ...
    tags: ['Few-Shot Learning', 'Computer Vision', 'Meta-Learning'],
    links: [
      { label: 'Code', url: 'https://github.com/ckindynis/DLPrototypicalNetworks' },
    ],
    featured: false,
    category: 'research',
    image: '/images/projects/prototypical.png',
  },
  {
    name: 'Art Generation with Small-Data GANs',
    description:
    ...
    tags: ['Art Generation', 'Computer Vision'],
    links: [
      { label: 'Report', url: '/files/SDCGAN.pdf' },
    ],
    featured: false,
    category: 'research',
    image: '/images/projects/sdcgan.png',
  },
  {
    name: 'Generative Question Answering for Legal Contracts',
    description:
    ...
    featured: false,
    category: 'research',
    image: '/images/projects/legal_ai.png',
  },
