        ...
        >
          ...
          <div className="flex flex-col items-center md:items-start gap-5 text-center md:text-left flex-1 max-w-2xl">
            ...
            >
              ...
              <motion.p variants={itemVariants}>
                Beyond research, I build things to solve problems I see around me and write about the process. Outside of AI, I care about personal finance, building good habits, and mental and physical well-being.
              </motion.p>
            </motion.div>
